							...
							<div class="box-body">
								...
								<div class="direct-chat-messages">
									...
									<div class="direct-chat-msg">
										...
										<!-- /.direct-chat-info -->
										<img class="direct-chat-img" src="/ttgl/js/AdminLTE-2.2.0/img/user1-128x128.jpg"
									...
									<div class="direct-chat-msg right">
										...
										<!-- /.direct-chat-info -->
										<img class="direct-chat-img" src="/ttgl/js/AdminLTE-2.2.0/img/user3-128x128.jpg"
											alt="message user image" />
										<!-- /.direct-chat-img -->
								...
								<div class="direct-chat-contacts">
									<ul class="contacts-list">
										<li><a href="#"> <img class="contacts-list-img"
												src="/ttgl/js/AdminLTE-2.2.0/img/user1-128x128.jpg" />
										...
										<!-- End Contact Item -->
										<li><a href="#"> <img class="contacts-list-img"
												src="/ttgl/js/AdminLTE-2.2.0/img/user7-128x128.jpg" />
												<div class="contacts-list-info">
										...
										<!-- End Contact Item -->
										<li><a href="#"> <img class="contacts-list-img"
												src="/ttgl/js/AdminLTE-2.2.0/img/user3-128x128.jpg" />
												<div class="contacts-list-info">
										...
										<!-- End Contact Item -->
										<li><a href="#"> <img class="contacts-list-img"
												src="/ttgl/js/AdminLTE-2.2.0/img/user5-128x128.jpg" />
												<div class="contacts-list-info">
										...
										<!-- End Contact Item -->
										<li><a href="#"> <img class="contacts-list-img"
												src="/ttgl/js/AdminLTE-2.2.0/img/user6-128x128.jpg" />
												<div class="contacts-list-info">
										...
										<!-- End Contact Item -->
										<li><a href="#"> <img class="contacts-list-img"
												src="/ttgl/js/AdminLTE-2.2.0/img/user8-128x128.jpg" />
												<div class="contacts-list-info">
						...
						<div class="box box-danger">
							...
							<div class="box-body no-padding">
								<ul class="users-list clearfix">
									<li><img src="/ttgl/js/AdminLTE-2.2.0/img/user1-128x128.jpg" alt="User Image" />
										<a class="users-list-name" href="#">Alexander Pierce</a> <span
										class="users-list-date">Today</span></li>
									<li><img src="/ttgl/js/AdminLTE-2.2.0/img/user8-128x128.jpg" alt="User Image" />
										<a class="users-list-name" href="#">Norman</a> <span
										class="users-list-date">Yesterday</span></li>
									<li><img src="/ttgl/js/AdminLTE-2.2.0/img/user7-128x128.jpg" alt="User Image" />
										<a class="users-list-name" href="#">Jane</a> <span
										class="users-list-date">12 Jan</span></li>
									<li><img src="/ttgl/js/AdminLTE-2.2.0/img/user6-128x128.jpg" alt="User Image" />
										<a class="users-list-name" href="#">John</a> <span
										class="users-list-date">12 Jan</span></li>
									<li><img src="/ttgl/js/AdminLTE-2.2.0/img/user2-160x160.jpg" alt="User Image" />
										<a class="users-list-name" href="#">Alexander</a> <span
										class="users-list-date">13 Jan</span></li>
									<li><img src="/ttgl/js/AdminLTE-2.2.0/img/user5-128x128.jpg" alt="User Image" />
										<a class="users-list-name" href="#">Sarah</a> <span
										class="users-list-date">14 Jan</span></li>
									<li><img src="/ttgl/js/AdminLTE-2.2.0/img/user4-128x128.jpg" alt="User Image" />
										<a class="users-list-name" href="#">Nora</a> <span
										class="users-list-date">15 Jan</span></li>
									<li><img src="/ttgl/js/AdminLTE-2.2.0/img/user3-128x128.jpg" alt="User Image" />
						...
						<ul class="products-list product-list-in-box">
							<li class="item">
								<div class="product-img">
									<img src="/ttgl/js/AdminLTE-2.2.0/img/default-50x50.gif" alt="Product Image" />
								</div>
								<div class="product-info">
									<a href="javascript::;" class="product-title">Samsung TV <span
										class="label label-warning pull-right">$1800</span></a> <span
										class="product-description"> Samsung 32" 1080p 60Hz LED
										Smart HDTV. </span>
								</div>
							</li>
							<!-- /.item -->
