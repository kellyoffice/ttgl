...
<a href="" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
	<span class="logo-mini"><b>帐</b></span> <!-- logo for regular state and mobile devices -->
	<span class="logo-lg"><b>家庭帐</b></span>
</a>
		...
		<ul class="nav navbar-nav">
						...
						<ul class="menu">
							<li>
								<!-- start message --> <a href="#">
									<div class="pull-left">
										<img src="/ttgl/js/AdminLTE-2.2.0/img/user2-160x160.jpg" class="img-circle"
											alt="User Image" />
									</div>
									<h4>
							...
							<li><a href="#">
									<div class="pull-left">
										<img src="/ttgl/js/AdminLTE-2.2.0/img/user3-128x128.jpg" class="img-circle"
											alt="User Image" />
									</div>
									<h4>
							...
							<li><a href="#">
									<div class="pull-left">
										<img src="/ttgl/js/AdminLTE-2.2.0/img/user4-128x128.jpg" class="img-circle"
											alt="User Image" />
									</div>
									<h4>
			...
			<li class="dropdown user user-menu"><a href="#"
				class="dropdown-toggle" data-toggle="dropdown"> <img
					src="/ttgl/js/AdminLTE-2.2.0/img/user2-160x160.jpg" class="user-image"
					alt="User Image" /> <span class="hidden-xs">Alexander
						Pierce</span>
			</a>
				<ul class="dropdown-menu">
					<!-- User image -->
					<li class="user-header"><img src="/ttgl/js/AdminLTE-2.2.0/img/user2-160x160.jpg"
